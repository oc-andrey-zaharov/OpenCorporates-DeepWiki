"""
WebSocket Server for Real-Time Wiki Generation Updates

OPTIONAL SERVICE: This module provides a WebSocket server for real-time wiki generation
updates. It is not required for CLI usage and can be run separately as an optional service.
...
To start the WebSocket server separately, see the README.md for instructions.
"""
...
class ChatCompletionRequest(BaseModel):
    ...
    type: Optional[str] = Field(
        "github", description="Type of repository (e.g., 'github')"
    )
